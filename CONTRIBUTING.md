...
* Add guides, tutorials, and recommendations [in the wiki](https://github.com/erichgoldman/disposable-email-helper/wiki)
...
2. The project maintainers will review any new services which is added, we may reject any service we feel is malicious in any matter.
3. Pull requests which do not maintain the code style or commenting requirements may be rejected.
4. This extension targets the Chrome browser and the extension may use API features not available in other browsers. All pull requests must be tested against the current version of Google Chrome.
